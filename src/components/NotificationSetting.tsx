          ...
          <ul className="w-full mt-2 text-gray-700">
            <li className="flex border-y py-2">
              ...
              <label className="inline-flex items-center cursor-pointer">
                <input onChange={(e) => setIsChecked(e.target.checked)} checked={isChecked || false} type="checkbox" value="notification" className="sr-only peer z-[2] pointer-events-none" />
                <div className="relative w-11 h-6 bg-gray-200  rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600 dark:peer-checked:bg-blue-600 z-[3]"></div>
              </label>
            </li>
          </ul>
        </div>
