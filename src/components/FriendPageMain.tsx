      ...
      <div className="px-4 py-2 max-h-[75vh] overflow-scroll">
        <div className="divide-y divide-gray-200 ">
          {friends && friends.length > 0 ? (
            ...
            <div className="w-full mx-auto my-6">No Friends Fround</div>
          )}
        </div>
      </div>
    );
    ...
    return (
      <>
        {request && request.length > 0 ? (
          <div className="min-w-full p-2 px-2 mx-2 bg-white max-h-[70vh] overflow-scroll my-6">
          ...
          <div className="min-w-full mx-auto my-10">No friends Request</div>
        )}
      </>
    );
  }
