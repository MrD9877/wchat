...
function InputOTPSlot({
  ...
  return (
    <div data-slot="input-otp-slot" data-active={isActive} className={cn("w-12 h-12 flex justify-center items-center border border-[theme(colors.weblue)] rounded-full", className)} {...props}>
      {char}
      {hasFakeCaret && (
